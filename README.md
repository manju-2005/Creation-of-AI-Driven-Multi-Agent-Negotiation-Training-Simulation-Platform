...
Simulation Mode: User observes two autonomous LLM-powered agents negotiate with each other.
Practice Mode: User participates directly as one of the negotiating parties against intelligent AI agents.
🌟 Key Features
3 Pre-Built Scenario Templates:
Vendor Pricing Negotiation: Price, quantity, warranty, and payment terms.
Job Offer Negotiation: Base salary, signing bonus, remote days, and equity.
Project Budget Allocation: Department funding, contingency reserves, and phase 1 release milestones.
